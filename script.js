...
const LANG = {
  sq:{
    ...
    ab_eye:'Rreth Meje',ab_h:'Pasioni im — drita dhe momenti',
    ...
    ab_p3:'Me mbi 5 vite përvojë dhe sy të mprehtë për detaje, sjell çdo vizion të klientit në jetë me profesionalizëm, ngrohtësi dhe dashuri për artin.',
  ...
  en:{
    ...
    ab_eye:'About Me',ab_h:'My passion — light and the moment',
    ...
    ab_p3:'With over 5 years of experience and a sharp eye for detail, I bring every client\'s vision to life with professionalism, warmth and a love of the art.',
